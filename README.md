...
* The Taylor's Theorem. Let k be an interger and let f(x) be k times differentiable at the point x=a, then there exists a function h(x) such that:<br><script type="text/javascript" src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=default"></script>\\(x=\frac{-b\pm\sqrt{b^2-4ac}}{2a} \\)
